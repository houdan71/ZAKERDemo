...
public class HotspotSecCommentsHotestAdapter extends BaseAdapter {
    ...
    @Override
    public int getCount() {
        return mCommentBean.getData().getComments().get(0).getList().size();
    }

    @Override
    public Object getItem(int position) {
        return mCommentBean.getData().getComments().get(0).getList().get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (type) {
            case 0:
                holder.name.setText(mCommentBean.getData().getComments().get(0).getList().get(position).getAuther_name());
                holder.time.setText(mCommentBean.getData().getComments().get(0).getList().get(position).getDate() + mCommentBean.getData().getComments().get(0).getList().get(position).getTime());
                holder.content.setText(mCommentBean.getData().getComments().get(0).getList().get(position).getContent());
                holder.good.setText(mCommentBean.getData().getComments().get(0).getList().get(position).getLike_num());

                if (mCommentBean.getData().getComments().get(0).getList().get(position).getAuther_icon() != "") {
                    Glide.with(MyApp.getContext()).load(mCommentBean.getData().getComments().get(0).getList().get(position).getAuther_icon()).bitmapTransform(new CropCircleTransformation(MyApp.getContext())).into(holder.head);
                } else {
            ...
            case 1:
                replyViewHolder.name.setText(mCommentBean.getData().getComments().get(0).getList().get(position).getAuther_name());
                replyViewHolder.time.setText(mCommentBean.getData().getComments().get(0).getList().get(position).getDate() + mCommentBean.getData().getComments().get(0).getList().get(position).getTime());
                replyViewHolder.content.setText(mCommentBean.getData().getComments().get(0).getList().get(position).getContent());
                replyViewHolder.good.setText(mCommentBean.getData().getComments().get(0).getList().get(position).getLike_num());

                replyViewHolder.replyName.setText(mCommentBean.getData().getComments().get(0).getList().get(position).getList().get(0).getAuther_name());
                replyViewHolder.replyContent.setText(mCommentBean.getData().getComments().get(0).getList().get(position).getList().get(0).getContent());
    ...
    public int getItemViewType(int position) {
        if (mCommentBean.getData().getComments().get(0).getList().get(position).getList() != null) {
            return 1;
        } else {
            return 0;
        }
