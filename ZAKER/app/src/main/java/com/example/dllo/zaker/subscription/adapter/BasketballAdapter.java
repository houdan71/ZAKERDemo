...
public class BasketballAdapter extends PagerAdapter implements OnClickListener{
    ...
    public int getCount() {
        ...
        return bean_basketball.getData().getArticles().size();
    }
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        text_today_title.setText(bean_basketball.getData().getArticles().get(position + 1).getTitle());
        text_today_name.setText(bean_basketball.getData().getArticles().get(position + 1).getAuther_name());
        text_today_titlee.setText(bean_basketball.getData().getArticles().get(position + 2).getTitle());
        text_today_namee.setText(bean_basketball.getData().getArticles().get(position + 2).getAuther_name());
        text_today_title_bottom.setText(bean_basketball.getData().getArticles().get(position + 3).getTitle());
        text_today_name_bottom.setText(bean_basketball.getData().getArticles().get(position + 3).getAuther_name());
        text_today_titlee_buttom.setText(bean_basketball.getData().getArticles().get(position + 4).getTitle());
        text_today_namee_buttom.setText(bean_basketball.getData().getArticles().get(position + 3).getAuther_name());
        text_view.setText(bean_basketball.getData().getArticles().get(position + 4).getTitle());
        text_tody_name.setText(bean_basketball.getData().getArticles().get(position + 4).getAuther_name());
