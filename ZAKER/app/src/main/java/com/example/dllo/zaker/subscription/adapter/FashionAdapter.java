...
public class FashionAdapter extends PagerAdapter implements OnClickListener{
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        Glide.with(context).load(bean_fashion.getData().getArticles().get(position).getThumbnail_pic()).into(image_today);

        text_today.setText(bean_fashion.getData().getArticles().get(position).getTitle());
        ...
        text_today_titlee_buttom.setText(bean_fashion.getData().getArticles().get(position+4).getTitle());
        text_today_namee_buttom.setText(bean_fashion.getData().getArticles().get(position+3).getAuther_name());
        text_view.setText(bean_fashion.getData().getArticles().get(position+4).getTitle());
        text_tody_name.setText(bean_fashion.getData().getArticles().get(position+4).getAuther_name());
