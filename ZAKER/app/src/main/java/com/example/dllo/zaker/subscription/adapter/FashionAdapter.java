 ...
 */
public class FashionAdapter extends PagerAdapter implements OnClickListener{
    private Context context;
    private Bean_fashion bean_fashion;
    ...
    public int getCount() {
        ...
        return bean_fashion.getData().getArticles().size();
    }
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        b = new ArrayList<>();
        for (int i = 0; i <bean_fashion.getData().getArticles().size(); i++) {

            HotspotSecBean bean = new HotspotSecBean();
            bean.setWebUrl(bean_fashion.getData().getArticles().get(i).getWeburl());
            b.add(bean);
        ...
        Glide.with(context).load(bean_fashion.getData().getArticles().get(position + 0).getThumbnail_pic()).into(image_today);
        text_today.setText(bean_fashion.getData().getArticles().get(position + 0).getTitle());
        text_today_title.setText(bean_fashion.getData().getArticles().get(position + 1).getTitle());
        text_today_name.setText(bean_fashion.getData().getArticles().get(position + 1).getAuther_name());
        text_today_titlee.setText(bean_fashion.getData().getArticles().get(position + 2).getTitle());
        text_today_namee.setText(bean_fashion.getData().getArticles().get(position + 2).getAuther_name());
        text_today_title_bottom.setText(bean_fashion.getData().getArticles().get(position + 3).getTitle());
        text_today_name_bottom.setText(bean_fashion.getData().getArticles().get(position + 3).getAuther_name());
        text_today_titlee_bottom.setText(bean_fashion.getData().getArticles().get(position + 4).getTitle());
        text_today_namee_bottom.setText(bean_fashion.getData().getArticles().get(position + 4).getAuther_name());
        text_view.setText(bean_fashion.getData().getArticles().get(position + 5).getTitle());
        text_tody_name.setText(bean_fashion.getData().getArticles().get(position + 5).getAuther_name());
    ...
    public void setBean_fashion(Bean_fashion bean_fashion) {
        this.bean_fashion = bean_fashion;
