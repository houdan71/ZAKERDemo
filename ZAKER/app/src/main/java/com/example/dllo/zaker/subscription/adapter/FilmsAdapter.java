 ...
 */
public class FilmsAdapter extends PagerAdapter implements OnClickListener{
    private Context context;
    private Bean_film bean_film;
    private int pos;
    ...
    public int getCount() {
        ...
        return bean_film.getData().getArticles().size();
    }
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        b = new ArrayList<>();
        for (int i = 0; i <bean_film.getData().getArticles().size(); i++) {

            HotspotSecBean bean = new HotspotSecBean();
            bean.setWebUrl(bean_film.getData().getArticles().get(i).getWeburl());
            b.add(bean);
        ...
        Glide.with(context).load(bean_film.getData().getArticles().get(position).getThumbnail_pic()).into(image_today);

        text_today.setText(bean_film.getData().getArticles().get(position).getTitle());

        text_today_title.setText(bean_film .getData().getArticles().get(position+1).getTitle());
        text_today_name.setText(bean_film.getData().getArticles().get(position+1).getAuther_name());
        text_today_titlee.setText(bean_film.getData().getArticles().get(position+2).getTitle());
        text_today_namee.setText(bean_film.getData().getArticles().get(position+2).getAuther_name());
        text_today_title_bottom.setText(bean_film.getData().getArticles().get(position+3).getTitle());
        text_today_name_bottom.setText(bean_film.getData().getArticles().get(position+3).getAuther_name());
        text_today_titlee_bottom.setText(bean_film.getData().getArticles().get(position+4).getTitle());
        text_today_namee_bottom.setText(bean_film.getData().getArticles().get(position+4).getAuther_name());
        text_view.setText(bean_film.getData().getArticles().get(position+5).getTitle());
        text_tody_name.setText(bean_film.getData().getArticles().get(position+5).getAuther_name());
    ...
    public void setBean_film(Bean_film bean_film) {
        this.bean_film = bean_film;
