 ...
 */
public class GeneralAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        text_today_title_bottom.setText(bean_general.getData().getArticles().get(position+3).getTitle());
        text_today_name_bottom.setText(bean_general.getData().getArticles().get(position+3).getAuther_name());
        text_today_titlee_buttom.setText(bean_general.getData().getArticles().get(position+4).getTitle());
        text_today_namee_buttom.setText(bean_general.getData().getArticles().get(position+3).getAuther_name());
        text_view.setText(bean_general.getData().getArticles().get(position+4).getTitle());
        text_tody_name.setText(bean_general.getData().getArticles().get(position+4).getAuther_name());
