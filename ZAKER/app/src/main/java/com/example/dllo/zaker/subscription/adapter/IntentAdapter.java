...
public class IntentAdapter extends PagerAdapter implements OnClickListener{
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        text_today_titlee_bottom.setText(bean_intent.getData().getArticles().get(position+4).getTitle());
        text_today_namee_bottom.setText(bean_intent.getData().getArticles().get(position+4).getAuther_name());
        text_view.setText(bean_intent.getData().getArticles().get(position+5).getTitle());
        text_tody_name.setText(bean_intent.getData().getArticles().get(position+5).getAuther_name());
