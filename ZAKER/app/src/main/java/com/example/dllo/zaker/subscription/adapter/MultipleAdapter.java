 ...
 */
public class MultipleAdapter extends PagerAdapter implements OnClickListener{
    private Context context;
    private Bean_multiple bean_multiple;
    ...
    public int getCount() {
        ...
        return bean_multiple.getData().getArticles().size();
    }
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        for (int i = 0; i <bean_multiple.getData().getArticles().size(); i++) {
            b = new ArrayList<>();
            HotspotSecBean bean = new HotspotSecBean();
            bean.setWebUrl(bean_multiple.getData().getArticles().get(i).getWeburl());
            b.add(bean);
        ...
        Glide.with(context).load(bean_multiple.getData().getArticles().get(position).getThumbnail_pic()).into(image_today);

        text_today.setText(bean_multiple.getData().getArticles().get(position).getTitle());

        text_today_title.setText(bean_multiple .getData().getArticles().get(position+1).getTitle());
        text_today_name.setText(bean_multiple.getData().getArticles().get(position+1).getAuther_name());
        text_today_titlee.setText(bean_multiple.getData().getArticles().get(position+2).getTitle());
        text_today_namee.setText(bean_multiple.getData().getArticles().get(position+2).getAuther_name());
        text_today_title_bottom.setText(bean_multiple.getData().getArticles().get(position+3).getTitle());
        text_today_name_bottom.setText(bean_multiple.getData().getArticles().get(position+3).getAuther_name());
        text_today_titlee_buttom.setText(bean_multiple.getData().getArticles().get(position+4).getTitle());
        text_today_namee_buttom.setText(bean_multiple.getData().getArticles().get(position+3).getAuther_name());
        text_view.setText(bean_multiple.getData().getArticles().get(position+4).getTitle());
        text_tody_name.setText(bean_multiple.getData().getArticles().get(position+4).getAuther_name());
    ...
    public void setBean_multiple(Bean_multiple bean_multiple) {
        this.bean_multiple = bean_multiple;
