 ...
 */
public class NumberAdapter extends PagerAdapter implements OnClickListener {
    private Context context;
    private Bean_number bean_number;
    private int pos;
    ...
    public int getCount() {
        ...
        return bean_number.getData().getArticles().size();
    }
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        b = new ArrayList<>();
        for (int i = 0; i < bean_number.getData().getArticles().size(); i++) {

            HotspotSecBean bean = new HotspotSecBean();
            bean.setWebUrl(bean_number.getData().getArticles().get(i).getWeburl());
            b.add(bean);
        ...
        Glide.with(context).load(bean_number.getData().getArticles().get(position).getThumbnail_pic()).into(image_today);

        text_today.setText(bean_number.getData().getArticles().get(position).getTitle());

        text_today_title.setText(bean_number.getData().getArticles().get(position + 1).getTitle());
        text_today_name.setText(bean_number.getData().getArticles().get(position + 1).getAuther_name());
        text_today_titlee.setText(bean_number.getData().getArticles().get(position + 2).getTitle());
        text_today_namee.setText(bean_number.getData().getArticles().get(position + 2).getAuther_name());
        text_today_title_bottom.setText(bean_number.getData().getArticles().get(position + 3).getTitle());
        text_today_name_bottom.setText(bean_number.getData().getArticles().get(position + 3).getAuther_name());
        text_today_titlee_bottom.setText(bean_number.getData().getArticles().get(position + 4).getTitle());
        text_today_namee_bottom.setText(bean_number.getData().getArticles().get(position + 4).getAuther_name());
        text_view.setText(bean_number.getData().getArticles().get(position + 5).getTitle());
        text_tody_name.setText(bean_number.getData().getArticles().get(position + 5).getAuther_name());
    ...
    public void setBean_number(Bean_number bean_number) {
