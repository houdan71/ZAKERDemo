...
public class TechnoloAdapter extends PagerAdapter implements OnClickListener{
  ...
  private Context context;
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        text_today_titlee_buttom.setText(bean_technolo.getData().getArticles().get(position+4).getTitle());
        text_today_namee_buttom.setText(bean_technolo.getData().getArticles().get(position+3).getAuther_name());
        text_view.setText(bean_technolo.getData().getArticles().get(position+4).getTitle());
        text_tody_name.setText(bean_technolo.getData().getArticles().get(position+4).getAuther_name());
